    ...
    <View>
      ...
      {(activity.oganizer === auth.currentUser.uid) ?
        (
          <>
            <Text>===========</Text>
            <PressableButton onPress={() => {editHandler(activity)}}>
              <Text>edit</Text>
            </PressableButton>
            <Text>===========</Text>
            <Text>===========</Text>
              <PressableButton onPress={() => {deleteHandler(activity)}}>
                <Text>delete</Text>
              </PressableButton>
            <Text>===========</Text>
        ...
        (
          (activity.participants.includes(auth.currentUser.uid)) ?
            <>
              <Text>===========</Text>
              <PressableButton onPress={() => {leaveHandler(activity)}}>
                <Text>leave</Text>
              </PressableButton>
              <Text>===========</Text>
            </>
            ...
            <>
              <Text>===========</Text>
              <PressableButton onPress={() => {joinHandler(activity)}}>
                <Text>join</Text>
              </PressableButton>
              <Text>===========</Text>
            </>
